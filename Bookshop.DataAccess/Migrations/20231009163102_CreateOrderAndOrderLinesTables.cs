...
{
    /// <inheritdoc />
    public partial class CreateOrderAndOrderLinesTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShipStreetAddress = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    BillStreetAddress = table.Column<string>(type: "nvarchar(max)", nullable: true),
