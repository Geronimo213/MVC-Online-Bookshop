...
namespace Bookshop.DataAccess.Migrations
{
    ...
    [Migration("20231213213423_UserOptionalOnCartAndOrder_AddSessionCookie")]
    partial class UserOptionalOnCartAndOrder_AddSessionCookie
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookListProduct", b =>
                {
            ...
            modelBuilder.Entity("Bookshop.Models.BookList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Bookshop.Models.Header", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookListProduct", b =>
                {
                    b.HasOne("Bookshop.Models.BookList", null)
                        .WithMany()
                        .HasForeignKey("BookListsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Bookshop.Models.Product", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Bookshop.Models.Order", b =>
                {
                    b.HasOne("Bookshop.Models.AppUser", "User")
                        .WithMany()
